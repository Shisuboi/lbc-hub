...
export async function renderOnboarding() {
    // /onboarding = page d'atterrissage si l'user est loggé mais sans profil
    // et sans token actif. On regarde sessionStorage en dernier recours.
    ...
    document.getElementById('appRoot').innerHTML = `
        <section class="auth-panel">
            <div class="auth-card card">
                ...
                <p class="muted">Aucune invitation active n'est associée à ton compte. Demande à l'admin un lien d'invitation.</p>
            </div>
        </section>`;
}
