...
def build_triage_prompt(ads: list[dict], grounding: dict) -> str:
    ...
    return (
        ...
        "- TITRE TROP VAGUE (modèle/état/capacité absents) → 'passable', score bas.\n"
        ...
        "40-59 = prix au marché sans avantage notable ou titre insuffisant ; "
        "0-39 = prix gonflé/dérisoire/suspect, pièces/cassé, titre vide.\n"
